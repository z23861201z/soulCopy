    ...
    public static class InventoryPacket
    {
        ...
        public static void getAvatar(Client c, Character chr)
        {
            using (OutPacket plew = new OutPacket(ServerOpcode.CHAR_SET_AVATAR))
            {
                ...
                {
                    WeaponUpgradeAttack += chr.Items[InventoryType.ItemType.Equip, (byte)InventoryType.EquipType.Weapon].Level1 * 20;
                    WeaponUpgradeAttack += chr.Items[InventoryType.ItemType.Equip, (byte)InventoryType.EquipType.Weapon].Level2 * 15;
                    WeaponUpgradeAttack += chr.Items[InventoryType.ItemType.Equip, (byte)InventoryType.EquipType.Weapon].Level3 * 10;
                    WeaponUpgradeAttack += chr.Items[InventoryType.ItemType.Equip, (byte)InventoryType.EquipType.Weapon].Level4 * 8;
